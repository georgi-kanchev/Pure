...
public class LayerSprites
{
	...
	public LayerSprites(SizeI size = default)
	{
		Size = size;
		Zoom = 1f;
	}
	...
	public void DragAndZoom(Window window, VecI dragDelta, float zoomDelta)
	{
	...
	public void Render(Window window)
	{
		...
		var texture = textures!.GetValueOrDefault(TexturePath ?? "", Effect.white);
