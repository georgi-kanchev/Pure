...
public static class Mouse
{
    ...
    /// </summary>
    public static VecI CursorPosition { get; private set; }
    public static VecI CursorDelta { get; private set; }
    ...
    public static void SimulateCursorMove(VecI position)
    {
