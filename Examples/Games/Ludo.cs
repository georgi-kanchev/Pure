...
public static class Ludo
{
    ...
    public static void Run()
    {
        ...
        while (Window.IsOpen)
        {
            ...
            map.Fill(new(Tile.SHADE_OPAQUE, Color.Gray.ToDark(0.6f)));
            SetMap(map);
            SetArrows(map);
    ...
    private static void SetMap(Tilemap map)
    {
        ...
        map.SetEllipse((cellsHorX + 6, cellsVertY + 6), (4, 4),
            new(Tile.SHADE_OPAQUE, teamColorYellow), false);
    ...
    private static void SetButton(Tilemap map, Element button)
    {
