...
using static Pure.Engine.Hardware.Keyboard.Key;
...
public static class Pong
{
	public static void Run()
	{
		...
		var window = new Window { Title = "Pure - Pong Example" };
		...
		while (window.KeepOpen())
		{
			...
			// player controls ====================================================
			paddleLeft = paddleLeft.MoveAt(270, hardware.Keyboard.IsPressed(ArrowUp) ? PADDLE_SPEED : 0, Time.Delta);
			paddleLeft = paddleLeft.MoveAt(90, hardware.Keyboard.IsPressed(ArrowDown) ? PADDLE_SPEED : 0, Time.Delta);
