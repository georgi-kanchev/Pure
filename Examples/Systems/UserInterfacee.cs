...
public static class UserInterfacee
{
	private class UI : Pure.UserInterface.UserInterface
	{
		...
		/*
		protected override void OnUserActionButton(Button button, Interaction userAction)
		{
			if(button.Text == "Button" && userAction == Interaction.Trigger)
				buttonClickCount++;
		}
	...
	public static void Run()
	{
		...
		ui.Add(new Scroll((46, 7)));
		ui.Add(new Palette((34, 23), brightnessLevels: 30));
		ui.Add(new Scroll((37, 16), false));
