...
public static class UserInterface
{
	private class UI : Pure.UserInterface.UserInterface
	{
		...
		protected override void OnDisplayStepper(Stepper stepper)
		{
			...
			maps[1].SetTile(e.Minimum.Position, new(Tile.MATH_MUCH_LESS, GetColor(e.Minimum, Color.Gray)));
			maps[1].SetTile(e.Middle.Position, new(Tile.PUNCTUATION_PIPE, GetColor(e.Middle, Color.Gray)));
			maps[1].SetTile(e.Maximum.Position, new(Tile.MATH_MUCH_GREATER, GetColor(e.Maximum, Color.Gray)));
		}
