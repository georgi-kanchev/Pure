...
public static class SlidersAndScrolls
{
	...
	{
		var sliderH = new Slider((1, 1), isVertical: false) { Size = (10, 10) };
		var sliderV = new Slider((12, 1), isVertical: true) { Size = (10, 10) };
		var scrollH = new Scroll((1, 12), isVertical: false);
		var scrollV = new Scroll((12, 12), isVertical: true);
