...
Container: left-games	Area: left, top + 5, width * 0.4, height - 6	Pivot: BottomLeft	Gap: 0, 0	Tile: 10	Wrap: SingleColumn
	...
	Button: longer		Text: very much looooonger		Size: text + 2, 3");
