...
Container: top			Area: left, top, width / 2, 1		Pivot: Left
...
Container: top-right	Pivot: Right		Area: left + width / 2, top, width / 2, 1	Color: 60, 60, 60, 255
	Button: speaker		Icon: 427			Size: 1, 1
	Button: bell		Icon: 353			Size: 1, 1
	Menu: profile		Text: @nickname438	Items: Profile, Account, Preferences, Wallet, Change Account, Sign Out		Size: 14, items		ItemSize: 14, 1		IsSingleSelecting
...
Container: left-games	Area: left, top + 5, width * 0.2, height - 6		Pivot: TopLeft	Gap: 0, 0
	Button: home		Text: Home			Size: width - 3, 3	IsSelected		Pad: 0, width - text - 1
