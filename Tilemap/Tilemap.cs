...
public class Tilemap
{
    ...
    /// </summary>
    public (int x, int y, int height, int width) Camera { get; set; }
    ...
    public void Replace((int x, int y) position, (int width, int height) size, Tile targetTile,
        (int x, int y, int z) seedOffset = default, params Tile[] tiles)
    {
        if (tiles.Length == 0)
            return;
    ...
    public void SetTextRectangle((int x, int y) position, (int width, int height) size,
        string? text,
        uint tint = uint.MaxValue, bool isWordWrapping = true,
        Alignment alignment = Alignment.TopLeft, float scrollProgress = 0)
    {
    ...
    public void SetTextRectangleTint((int x, int y) position, (int width, int height) size,
        string? text, uint tint = uint.MaxValue, bool isMatchingWord = false)
    {
    ...
    public void SetEllipse((int x, int y) center, (int width, int height) radius, Tile tile,
        bool isFilled = true)
    {
    ...
    public (float x, float y) PointFrom((int x, int y) pixelPosition,
        (int width, int height) windowSize, bool isAccountingForCamera = true)
    {
    ...
    private static float Random(float rangeA, float rangeB, float precision = 0,
