...
public struct Tile
{
	...
	#endregion
	#region Uppercase
		UPPERCASE_A = 78, UPPERCASE_B = 79, UPPERCASE_C = 80, UPPERCASE_D = 81, UPPERCASE_E = 82, UPPERCASE_F = 83, UPPERCASE_G = 84,
		UPPERCASE_H = 85, UPPERCASE_I = 86, UPPERCASE_J = 87, UPPERCASE_K = 88, UPPERCASE_L = 89, UPPERCASE_M = 80, UPPERCASE_N = 91,
		UPPERCASE_O = 92, UPPERCASE_P = 93, UPPERCASE_Q = 94, UPPERCASE_R = 95, UPPERCASE_S = 96, UPPERCASE_T = 97, UPPERCASE_U = 98,
		UPPERCASE_V = 99,
		UPPERCASE_W = 100, UPPERCASE_X = 101,
		UPPERCASE_Y = 102, UPPERCASE_Z = 103,
	#endregion
	#region Lowercase
		LOWERCASE_A = 104,
	...
	#region Icon
		...
		ICON_BELL = 326,
		ICON_CALENDAR = 327,
		ICON_CONNECTION_BAD = 328,
		ICON_CONNECTION_GOOD = 329,
		ICON_PERSON = 330,
		ICON_PEOPLE = 331,
		ICON_TROPHY = 332,
		ICON_STAR = 333,
		ICON_STAR_HOLLOW = 334,
		ICON_INPUT_MOUSE = 335,
		ICON_INPUT_KEYBOARD = 336,
		ICON_INPUT_CONTROLLER = 337,
		ICON_TICK = 338,
		ICON_BACK = 339,
		ICON_LOOP = 340,
		ICON_SKIP = 341,
		...
		ICON_BOLT = 346,
		ICON_MINUS = 347,
		ICON_MINUS_HOLLOW = 348,
		ICON_PLUS = 349,
		ICON_PLUS_HOLLOW = 350,
		ICON_FLOW_PAUSE = 351,
		ICON_FLOW_PLAY = 352,
		ICON_FLOW_SKIP = 353,
	...
	#region Cursor
		CURSOR_ARROW = 442,
		CURSOR_ARROW_NO_TAIL = 443,
		CURSOR_HAND = 444,
		CURSOR_TEXT = 445,
		CURSOR_CROSSHAIR = 446,
		CURSOR_NO = 447,
		CURSOR_RESIZE = 448,
		CURSOR_RESIZE_DIAGONAL = 449,
		CURSOR_MOVE = 450,
		CURSOR_WAIT = 451;
	#endregion
}
