...
public class FileViewer : Element
{
	...
	protected override void OnUserAction(UserAction userAction)
	{
		if(userAction == UserAction.Scroll)
			FilesAndFolders.Scroll.Slider.Progress -= Input.Current.ScrollDelta * FilesAndFolders.Scroll.Step;
	}
	...
	{
		return IsFocused && (FocusedPrevious == Back || FilesAndFolders.AreAnyChildrenStillFocused());
	}
