...
public abstract partial class Element
{
	...
	internal static Element? FocusedPrevious { get; set; }
	/// <summary>
	...
	private bool IsStillFocused => IsFocused && FocusedPrevious == this;
	...
	public virtual void Update()
	{
		...
		var isStillFocused = IsStillFocused || AreAnyChildrenStillFocused();
		...
		if((px != ppx || py != ppy) && IsPressedAndHeld && IsStillFocused)
		{
		...
		if(IsHovered && isStillFocused && // scroll even when hovering children
			Input.Current.ScrollDelta != 0) // if any
	...
	internal virtual bool AreAnyChildrenStillFocused() => false;
