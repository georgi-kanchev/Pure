...
internal class TilePalette
{
	...
	public void TryDraw()
	{
		...
		if(Mouse.IsButtonPressed(Mouse.Button.Left) || Mouse.IsButtonPressed(Mouse.Button.Middle))
	...
	{
		return inspector != null && inspector.IsHovered == false &&
			editor.Prompt.IsHidden && Program.menu.IsHidden;
	}
