namespace Purity.Utilities
{
	...
	public static class Time
	{
		...
		/// - Example: An object moving with the speed of 1 pixel per frame/tick/update in a game running at 60 <see cref="UPS"/> will
		/// be moving with 60 pixels per second.<br></br> But on a game running at 120 <see cref="UPS"/> - it will be moving with 120 pixels per
		...
		/// (when the <see cref="UPS"/> drops bellow 40, 30, 20).<br></br>
		...
		/// <summary>
		/// The average <see cref="UPS"/> since the start of the application. See <see cref="UPS"/> for more info.
		/// </summary>
		public static float AverageUPS { get; private set; }
		/// <summary>
		...
		public static void Update()
		{
			...
			if(updateFPS > UPDATE_FPS_EVERY_X_SEC)
			{
				updateFPS = 0;
				UPS = 1f / Delta;
				AverageUPS = FrameCount / GameClock;
			}
			FrameCount++;
